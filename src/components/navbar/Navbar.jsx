  ...
  return (
    <nav className='font-Poppins'>
      <div
        ...
        className={`${
          isScroll ? 'shadow-md' : ''
        } fixed left-0 top-0 right-0 z-10 mx-auto grid w-full grid-cols-3 items-center justify-between bg-white py-3 px-4 sm:px-44`}
      >
        <div className='col-span-2'>
          <h1 className='text-xl font-bold text-main'>HealthifyMe</h1>
        </div>
        <div
          className={`absolute ${
